import qnodecoin_hash
from binascii import unhexlify, hexlify

import unittest

# qnodecoin block #1
# moo@b1:~/.qnodecoin$ qnodecoind getblockhash 1
# 000007d91d1254d60e2dd1ae580383070a4ddffa4c64c2eeb4a2f9ecc0414343
# moo@b1:~/.qnodecoin$ qnodecoind getblock 000007d91d1254d60e2dd1ae580383070a4ddffa4c64c2eeb4a2f9ecc0414343
# {
...
class TestSequenceFunctions(unittest.TestCase):
    ...
    def test_qnodecoin_hash(self):
        self.pow_hash = hexlify(qnodecoin_hash.getPoWHash(self.block_header))
